...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'date' => 'date',
        'department_id' => 'Department',
        'details.*.statement_id'                 => 'Statement',
        'details.*.used_area'                    => 'Used Area',
        'details.*.unit_area'                    => 'Unit Area',
        'details.*.number_of_buildings_executed' => 'Number of Buildings Executed',
        'details.*.number_of_units'              => 'Number of Units',
        'details.*.residential_units'            => 'Residential Units',
        'details.*.administrative_units'         => 'Administrative Units',
        'details.*.commercial_units'             => 'Commercial Units',
        'details.*.commercial_shops'             => 'Commercial Shops',
        'details.*.note'                         => 'Note',
        'type_service_id'           => 'Type of Service',
        'services.*.type_service_id' => 'Type of Service',
