    ...
    <x-dialog-modal wire:model="add_coodinates" submit="save()" method="PATCH">
        ...
        <x-slot name="content">
            <div class="grid gap-4">
                <div x-data="mapComponent(@entangle('map_government'), @entangle('map_city'), @entangle('coordinates'), @entangle('total_area_coords'))"
                    x-init="init();
                    ...
                    <div>
                        <div class="flex items-center gap-x-2 mt-2">
                            ...
                            <x-indigo-button class="" wire:click="uploadCoordinates">
                    ...
                    <div>
                        <x-textarea x-model="coordsInput" class="border p-2 rounded w-full mt-2" rows="3"
        ...
        <x-slot name="footer">
            ...
            <x-secondary-button class="mx-2" wire:click="$set('add_coodinates',false)" wire:loading.attr="disabled">
                {{ __('site.cancel') }}
            </x-secondary-button>
        </x-slot>
        @endif
