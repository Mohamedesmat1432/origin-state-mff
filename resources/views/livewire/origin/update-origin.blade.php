        ...
        <x-dialog-modal wire:model="edit_modal" submit="save()" method="PATCH" max-width="5xl">
            @if ($this->edit_modal)
                ...
                <x-slot name="content">
                    ...
                    <div class="mt-2">
                        @foreach ($details as $index => $detail)
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div class="mt-2 pt-5">
                                    <x-danger-button class="p-1" wire:click="removeDetail({{ $index }})"
                    ...
                    <div class="mt-2">
                        <x-form.field label="{{ __('site.sepated_services') }}" model="sepated_services" type="textarea"
                            placeholder="{{ __('site.sepated_services') }}" />
                    </div>
                </x-slot>
