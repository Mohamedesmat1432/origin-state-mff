                    ...
                    <div class="flex mt-2">
                        ...
                        <label class="relative cursor-pointer hover:bg-gray-50 transition">
                            ...
                            <div class="text-white 
                                    ...
                                    {{ $location_status == $status ? 'opacity-100' : 'opacity-50' }}
                                    {{ $status->color() }}">
                                {{ $status->label() }}
                            </div>
                        </label>
                    ...
                    <div class="flex mt-2">
                        ...
                        <label class="relative cursor-pointer hover:bg-gray-50 transition">
                            ...
                            <div class="text-white 
                                {{ $loop->first ? 'rtl:rounded-r ltr:rounded-l' : 'rounded-none' }}
                                {{ $loop->last ? 'rtl:rounded-l ltr:rounded-r' : 'rounded-none' }}
                                {{ $origin_status == $status ? 'opacity-100' : 'opacity-50' }}
                                {{ $status->color() }}">
                                {{ $status->label() }}
                            </div>
                        </label>
                    ...
                    @if ($file)
                        ...
                        @if (strtolower($extension) === 'pdf')
                            <div class="mt-4">
                                ...
                                {{-- <img src="{{ $fileUrl }}" alt="Preview of Uploaded" class="w-8 h-8 mr-2"> --}}

                                <iframe src="{{ $fileUrl }}" width="100%" height="600px" class="border rounded shadow"></iframe>
                            </div>
                        @endif
