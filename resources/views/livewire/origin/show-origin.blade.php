                ...
                <x-slot name="content">
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="mt-2">
                                <x-label class="font-extrabold text-lg" for="project_id"
                                    value="{{ __('site.project_id') }}" />
                            ...
                            <div class="mt-2">
                                <x-label class="font-extrabold text-lg" for="used_area"
                                    value="{{ __('site.used_area') }}" />
                                <div class="mt-1 block w-full">
                            ...
                            <div class="mt-2">
                                <x-label class="font-extrabold text-lg" for="created_by"
                                    value="{{ __('site.created_by') }}" />
                                <div class="mt-1 block w-full">
                            ...
                            <div class="mt-2">
                                <x-label class="font-extrabold text-lg" for="revised_by"
                                    value="{{ __('site.revised_by') }}" />
                                <div class="mt-1 block w-full">
                            ...
                            <div class="mt-2">
                                <x-label class="font-extrabold text-lg" for="statement_ids"
                                    value="{{ __('site.statement_ids') }}" />
                                <div class="mt-1 block w-full">
                        ...
                        <div class="gap-x-4">
                            <div class="mt-2">
                                <x-label class="font-extrabold text-lg" for="details"
                                    value="{{ __('site.details') }}" />
                                ...
                                @if (!empty($this->origin->details?->toArray()))
                                    <x-table>
                                        ...
                                        <x-slot name="tbody">
                                            @foreach ($this->origin->details?->toArray() as $detail)
