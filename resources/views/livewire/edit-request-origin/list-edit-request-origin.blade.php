            ...
            <div class="text-gray-500 leading-relaxed">
                <div>
                    <div class="md:flex justify-between">
                        ...
                        <x-form.enum-group model="filters.status" :extra="['wire:model.live.debounce.200ms' => 'filters.status']" :enum="\App\Enums\EditRequestOriginStatus::class" filter-status="true"
                            :filter-count="$this->editRequestOriginsCount()" />
                    </div>
                </div>
