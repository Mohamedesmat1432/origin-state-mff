...
('5adbbd48-f283-4a8a-8f17-5d170ad0bb6f','a19237b5-9d95-4e6d-ac97-80d6c372a4f4',100.00,200,NULL,NULL,NULL,NULL,NULL,'2025-07-22 09:52:38','2025-07-22 09:52:38');
/*!40000 ALTER TABLE `origin_details` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `origin_statement`
--

DROP TABLE IF EXISTS `origin_statement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `origin_statement` (
  `origin_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `statement_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`origin_id`,`statement_id`),
  KEY `origin_statement_statement_id_foreign` (`statement_id`),
  CONSTRAINT `origin_statement_origin_id_foreign` FOREIGN KEY (`origin_id`) REFERENCES `origins` (`id`) ON DELETE CASCADE,
  CONSTRAINT `origin_statement_statement_id_foreign` FOREIGN KEY (`statement_id`) REFERENCES `statements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `origin_statement`
--

LOCK TABLES `origin_statement` WRITE;
/*!40000 ALTER TABLE `origin_statement` DISABLE KEYS */;
INSERT INTO `origin_statement` VALUES
('183885e1-7681-42cf-a63c-99fecd470fa3','114e446a-71c7-4e79-a6d5-0ddf770b7a8d'),
('8ec047d1-b9c0-4e45-a61e-8c1851ddd8bc','114e446a-71c7-4e79-a6d5-0ddf770b7a8d'),
('a8b81ff9-507a-489e-9694-19abbc8bb84c','114e446a-71c7-4e79-a6d5-0ddf770b7a8d'),
('40e8dcfc-d87c-4958-aa4d-b17bb05110f3','5cc76d6c-a2ba-4209-81b6-063e0b5c52f0'),
('9b372dd0-c0c6-497b-8c7b-3592ab39182a','5cc76d6c-a2ba-4209-81b6-063e0b5c52f0'),
('d37f766e-6d40-4626-b592-b3b53b0188bd','5cc76d6c-a2ba-4209-81b6-063e0b5c52f0'),
('34f0e90c-c6e9-4f64-917b-0a7200cefee5','b95742fc-80c0-44d7-897c-88e52d11fc23'),
('0fcbcbd8-1c21-4799-ad3a-e02975839dd6','bae76f11-3713-4690-b9e7-5cfd27d252f8'),
('ef75af0e-d4f4-4cb1-bf5c-d8310069eb2c','bae76f11-3713-4690-b9e7-5cfd27d252f8'),
('05c3e92e-ab0e-4394-8add-5fc0b9287a53','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('0bf2f408-7733-47f9-8805-9847cc3408cd','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('12782081-8b6f-49c8-b0df-c0dd0b5b66bc','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('133464b3-9283-4b66-89f7-a799c38d796d','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('265de0be-60a1-4a82-8108-d5c7a2b13204','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('45318d0e-a020-4859-bf6b-eff3220ae2da','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('7955112d-dbc7-4eb6-b1c9-e5b66b8c4b39','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('a19237b5-9d95-4e6d-ac97-80d6c372a4f4','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('c7450ead-7746-4f32-a04f-7f4bd11df995','d13e1541-82c3-4f97-b5ad-4acc423dd119'),
('f1adfec5-664d-4b68-8e46-7b05a438c5f4','d13e1541-82c3-4f97-b5ad-4acc423dd119');
/*!40000 ALTER TABLE `origin_statement` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `origins` (
  ...
  `sepated_services` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-07-28 11:42:23
