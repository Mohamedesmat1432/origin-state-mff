...
<?php $component->withAttributes(['wire:model' => 'create_modal','submit' => 'save()','method' => 'POST']); ?>
             <?php $__env->slot('title', null, []); ?> 
                <?php echo e(__('site.create_new_department')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'text','class' => 'mt-1 block w-full','wire:model' => 'name','placeholder' => ''.e(__('site.name')).'','autocomplete' => 'department-name-ar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','class' => 'mt-1 block w-full','wire:model' => 'name','placeholder' => ''.e(__('site.name')).'','autocomplete' => 'department-name-ar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/resources/views/livewire/department/create-department.blade.php ENDPATH**/ ?>