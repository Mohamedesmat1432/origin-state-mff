...
<?php foreach($attributes->onlyProps(['permission', 'id', 'name']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['permission', 'id', 'name']); ?>
<?php foreach (array_filter((['permission', 'id', 'name']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/resources/views/components/delete-button.blade.php ENDPATH**/ ?>