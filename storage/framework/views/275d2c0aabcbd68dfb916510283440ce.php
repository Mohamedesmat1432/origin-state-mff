...
<?php endif; ?>
        ...
        function chartUser() {
            return {
                ...
                initChartUser() {
                    ...
                    const chartDataUser = <?php echo \Illuminate\Support\Js::from($chartDataUser)->toHtml() ?>;
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH /var/www/resources/views/livewire/chart/chart-user.blade.php ENDPATH**/ ?>